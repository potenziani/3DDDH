...
function sectiontoolSwitch(on) {
  ...
  if(on){
	...
	jQuery('#sections-box img').css("visibility", "hidden"); //comment if you are not using sectiontoolReset()
	presenter.setClippingXYZ(0, 0, 0); //comment if you are not using sectiontoolReset()
  }
}
